...
const FLASH_SCREENS = {
  ...
  "situs-inversus": flashScreenForUsedEvent,
  "itsAlive": flashScreenForUsedOnOrganEvent,
  "sedate": flashScreenForUsedOnPlayerEvent,
  "narcolepsy": flashScreenForUsedOnPlayerEvent,
  "cryopreservation": flashScreenForUsedEvent,
